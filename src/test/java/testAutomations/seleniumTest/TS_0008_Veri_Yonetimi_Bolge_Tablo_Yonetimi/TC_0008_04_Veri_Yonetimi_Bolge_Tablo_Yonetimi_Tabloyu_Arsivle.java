...
public class TC_0008_04_Veri_Yonetimi_Bolge_Tablo_Yonetimi_Tabloyu_Arsivle extends testAutomations.TestBase {
    ...
    @FindBy(css = "#index-region-table > div > div.card-body.pt-5.pb-5 > div > div:nth-child(1) > a.btn.btn-icon.btn-light-info.btn-sm.mr-2")
    ...
    public WebElement tabloArsivleOnay;

    @Test
       
    public void testTC_0008_04_Veri_Yonetimi_Bolge_Tablo_Yonetimi_Tabloyu_Arsivle() throws Exception {
        ...
        WebElement[] elements = {panel,veriYonetimi,bolgeTabloYonetim,tabloArsivle,tabloArsivleOnay};
