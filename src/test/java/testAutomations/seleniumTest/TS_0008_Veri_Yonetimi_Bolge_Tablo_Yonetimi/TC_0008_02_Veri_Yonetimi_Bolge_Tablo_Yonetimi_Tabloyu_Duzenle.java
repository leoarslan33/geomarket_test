...
public class TC_0008_02_Veri_Yonetimi_Bolge_Tablo_Yonetimi_Tabloyu_Duzenle extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//body/div[@id='IndexTablePanel']/div[2]/div[1]/div[1]/div[2]/div[1]/div[1]/a[2]")
    public WebElement bolgeTabloDüzenle;
    ...
    public void testTC_0008_02_Veri_Yonetimi_Bolge_Tablo_Yonetimi_Tabloyu_Duzenle() throws Exception {
        ...
        WebElement[] elements = { panel, veriYonetimi, bolgeTabloYonetim, bolgeTabloDüzenle, addTableName, addKolonName,
                takeLookUp, yesNo, partIslemleri, addPartNameIn, orderNo, partSave, addPart, addKolonName2, takeLookUp2,
                yesNo2, save };
        ...
        for (WebElement element : elements) {
            try {
                ...
                element.click();
                if (element == elements[4] || element == elements[5] || element == elements[9]
                        || element == elements[13])

                {

                    element.sendKeys("test_Düzenle");
                } else {
