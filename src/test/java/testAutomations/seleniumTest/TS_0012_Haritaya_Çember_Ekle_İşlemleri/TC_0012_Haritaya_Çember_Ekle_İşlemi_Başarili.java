package testAutomations.TS_0003_İl_İlçe_Mahalle_Sinirlarinin_Görüntülenmesi;
...
public class TC_0012_Haritaya_Çember_Ekle_İşlemi_Başarili extends testAutomations.TestBase {
    ...
    public WebElement bölgeAdiGirisi;

    @FindBy(xpath = "//input[@id='3606']")
    public WebElement müsteriAdi;
    ...
    @Test
    public void testTC_0012_Haritaya_Çember_Ekle_İşlemi_Başarili() throws Exception {
        ...
        try{
            ...
            Logger.warn("Kullanici login olamadi.");
        }
        ...
        Fwait.until(ExpectedConditions.visibilityOf(bölgeAdiGirisi));
        bölgeAdiGirisi.sendKeys("otomasyontest");

        Fwait.until(ExpectedConditions.visibilityOf(müsteriAdi));
        müsteriAdi.sendKeys("123");
