...
public class TC_0022_03_Ekran_Goruntusu_JPG extends testAutomations.TestBase {
    ...
    public WebElement ciktiAlJpg ;

     
    @Test

    public void testTC_0022_03_Ekran_Goruntusu_JPG() throws Exception {
        ...
        WebElement[] elements = {SSscreen,ciktiAlJpg};
